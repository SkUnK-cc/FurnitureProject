 ...
 * @date 2017/8/14
 */
public class OtherListAdapter extends UltimateViewAdapter {

    private List<DetailTypeBean> detailTypeBeanList;
    private OnItemClickListener mItemClickListener;

    public OtherListAdapter(List<DetailTypeBean> mAccountList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_other_list, parent, false);
